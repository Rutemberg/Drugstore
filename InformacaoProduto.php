    ...
    <body style="background: #f6f6f6">
        ...
        <div id="menu">
            <ul>
                ...
                <li><a href="CategoriaProduto.php?Categoria=Generico">Genericos</a>
                    <ul></ul>
                </li>
                <li><a href="CategoriaProduto.php?Categoria=Acessorio">Acessorios</a>
                    <ul></ul>
                </li>
        ...
        <div style="width: 90%;margin: 0 auto;margin-top: 30px;padding-bottom: 15px;padding-top: 10px;position: relative;font-weight: bolder">
            <?php
            ...
            <?php
            require_once 'Controle/DAO/Conexao2.php';
            $query = mysql_query("SELECT * FROM produto WHERE codProduto = '$_SESSION[codProduto]' and estatusprod = 'Ativo'");
            $contadorproduto = 0;
            while ($resultado = mysql_fetch_assoc($query)) {
                $contadorproduto ++;
                if ($resultado['quantidade'] <= 0) {
                    ...
                    <div class="infoproduto">
                        <div style="width: 50%;height: auto;display: inline-block;height: 500px;margin: 0;">
                            <div class="infoimagemproduto"> <?php echo '<img src="Img/ImagensBanco/' . $resultado['imagem'] . '" style="width: auto;height: 100%;margin: 0px;border-radius: 3px"/>'; ?> </div> 
                        </div>
                        <div style="width: 45%;display: inline-block;height: 500px;margin: 0;overflow: hidden;border-radius: 3px">
                            <p class="infonomeproduto"><?php echo $resultado['nome']; ?></p>
                            <div class="infodescricaoproduto"><?php echo $resultado['descricao']; ?></div>
                            <div class="estoqueproduto">Em estoque: <?php echo $resultado['quantidade']; ?> unidades</div>
                            <p style="font-size: 25px;color: #4d4d4d;width: 70%;margin: 0 auto;text-align: left;height: 40px;">Preço:</p>
                            <p style="font-size: 30px;color: #f94c3b;width: 70%;margin: 0 auto;text-align: right;height: 40px;"><?php echo 'R$' . ' ' . $resultado['valor'] = number_format($resultado['valor'], 2, ',', '.'); ?></p>
                            <?php if (isset($_SESSION['ClienteLogado'])) { ?>
                                <a href="ProdutosCarrinho.php?acao=add&id=<?php echo $resultado['codProduto']; ?>">
                                    <div class="infoadicionarcesta"><p style="width: 80%;margin: 0;height: 50px;line-height: 50px;font-size: 20px;color: white;float: left">Adicionar à cesta</p>

                                    </div>
                                </a>
                            <?php } else { ?>
                                <div class="infoadicionarcesta" style="background-image: none"><p style="width: 100%;margin: 0;height: 50px;line-height: 50px;font-size: 20px;color: white;">Logue-se para adicionar a cesta</p>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
