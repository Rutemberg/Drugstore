        ...
        <div style="width: 100%;height: 700px;overflow: auto;border-radius: 3px;position: relative;padding-top: 140px;margin: 0 auto;">
            ...
            while ($resultado = mysql_fetch_assoc($query)) {
                ...
                <div style="width: 700px;margin: 0 auto;margin-bottom: 20px;background: white;padding-top: 5px;box-shadow: 0 0 5px rgba(0,0,0, .2);position: relative">                        
                    <div>
                        ...
                        <p style="position: absolute;top: 0;left: 0px;margin: 0;font-size: 12px;text-align: right;color: #aaa">Estatus: Recebido</p> 
                        <?php } ?>
                        <?php if($resultado['estatusvenda'] == 'Enviando') {?>
                        <p style="position: absolute;top: 0;left: 0px;margin: 0;font-size: 12px;text-align: right;color: #aaa">Estatus: Enviada para entrega</p> 
                        <?php } ?>
                        <?php if($resultado['estatusvenda'] == 'Entregando') {?>
                        <p style="position: absolute;top: 0;left: 0px;margin: 0;font-size: 12px;text-align: right;color: #aaa">Estatus: Entregando</p> 
                        <?php } ?>
            ...
            <div style="width: 500px;margin: 0 auto;height: 100px;position: absolute;top: 0;left: 50%;margin-left: -250px;margin-top: 10px;">
                <div style="width: 200px;display: inline-block;background: white;height: 100px;box-shadow: 0 0 5px rgba(0,0,0, .2);overflow: hidden">
                    <p style="font-size: 17px;color: #333;">Compras em andamento</p> 
