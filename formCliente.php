...
//                UF
    ...
    <body>
        ...
        <div id="corpoform" style="overflow: hidden;height: 515px;background: none">
...
<!--                                <p style="text-align:left;font-size: 12px;color: #BBB;margin: 0;padding-bottom: 15px;margin-left: 30px;font-weight: bolder">Precisamos apenas de algumas informações</p> -->
            <form id="form" 
                  ...
                  name="form" 
                  action="Controle/controladorCliente.php?ACAO=cadastrarcliente" 
                  method="post"
                ...
                <div id="infoconta" style="height: 490px">
                    <p class="topformulario">Informações do Cliente</p>
                    <div class="imagemconta">
                        <div class="imagemprodutoview" style="width: 90%;height: 150px;border: 1px solid #d9d9d9;margin: 0 auto;margin-top: 10px;overflow: hidden"><img id="blah" src="" alt="" style="height: 100%;width: auto"/></div>

                        <label>Selecione uma imagem:</label>
                        <label for="foto" class="labelinputfile" style=" width: 127px;line-height: 32px;text-align: center;z-index: 4;position: relative;">Escolher imagem</label>                  
    ...
    <!--                            <input type="button" id="botaoanterior" value="Anterior">
                ...
                <div id="infoconta2" style="height: 490px;">
                    <label style="margin-top: 30px">Cep (Somente números):</label>
                    <input type="text" 
                           name="cep"
                           value=""
                           id="cep">
