    ...
    <head>
        ...
        <script>
            function pesquisa(valor)
            {
                ...
                url = "busca_nomeFuncionario.php?valor=" + valor;
                ajax(url);
            }
        </script>
        ...
        switch ($acao) {
            case 'listar':
                                ...
                                <?php if ($funcionario->estatus == "Ativo") { ?>
                                    <a href="Restrito.php?PAGINA=alterarFuncionario&&idFuncionario=<?php echo $funcionario->idFuncionario; ?>">
                                        <li>
                                            ...
                                            <a class="alterar" style="background: #617e88" href="Restrito.php?PAGINA=alterarFuncionario&&idFuncionario=<?php echo $funcionario->idFuncionario ?>">Alterar Funcionario</a>
                                        </li> 
                                    </a>
                                <?php } ?>
                            <?php } ?>
                ...
                if (isset($_SESSION['MENSAGEMATIVO'])) {
                    if (($_SESSION['MENSAGEMATIVO']) == 1) {
                        ...
                        <div id="msglogin" style="display: none;width: 500px;height: 100px;line-height: 100px;position: absolute;top: 50%;left: 50%;margin-top: -50px;margin-left: -250px;z-index: 15;background: white;border-radius: 3px;box-shadow: 0 0px 10px rgba(0, 0, 0, 0.2);">
                            <p style="margin:0;padding: 0;font-size: 18px;color: #333;">Funcionario ativado com sucesso!</p>
                        </div>
                ...
                if (isset($_SESSION['MENSAGEMALTERAR'])) {
                    if (($_SESSION['MENSAGEMALTERAR']) == 1) {
                        ...
                        <div id="msglogin" style="display: none;width: 500px;height: 100px;line-height: 100px;position: absolute;top: 50%;left: 50%;margin-top: -50px;margin-left: -250px;z-index: 15;background: white;border-radius: 3px;box-shadow: 0 0px 10px rgba(0, 0, 0, 0.2)">
                            <p style="margin:0;padding: 0;font-size: 18px;color: #333;">Funcionário alterado com sucesso!</p>
                        </div>
                ...
                if (isset($_SESSION['MENSAGEMCADASTRO'])) {
                    if (($_SESSION['MENSAGEMCADASTRO']) == 1) {
                        ...
                        <div id="msglogin" style="display: none;width: 500px;height: 100px;line-height: 100px;position: absolute;top: 50%;left: 50%;margin-top: -50px;margin-left: -250px;z-index: 15;background: white;border-radius: 3px;box-shadow: 0 0px 10px rgba(0, 0, 0, 0.2)">
                            <p style="margin:0;padding: 0;font-size: 18px;color: #333;">Funcionario cadastrado com sucesso!</p>
                        </div>
            ...
            case 'desativar':
                ...
                if ($deletar) {
                    ...
                    echo "<script>
                        window.location.href='Restrito.php?PAGINA=listarFuncionarioDesativo';
                        </script>";
                }
                break;
            case 'ativar':
            ...
            case 'Atualizar':
                ...
                if ($alterarFuncionario == FALSE) {
                    ...
                    $_SESSION['MENSAGEMALTERARMINHASINFORMAÇOES'] = 1;
                    echo "<script>
