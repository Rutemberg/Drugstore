    ...
    <head>
        ...
        <script>
            function pesquisa(valor)
            {
                ...
                url = "busca_nomeProduto.php?valor=" + valor;
                ajax(url);
            }
        </script>
                        ...
                        <?php if (!empty($_GET["valor"]) == null) { ?>
                            <?php foreach ($produtos as $produto) { ?>
                                ...
                                if ($produto->quantidade <= 0) {
                                    ...
                                    $sql = "UPDATE produto SET estatusprod = ? WHERE codProduto = " . $produto->codProduto;
            ...
            <?php } ?>
                ...
                if (isset($_SESSION['MENSAGEMATIVO'])) {
                    if (($_SESSION['MENSAGEMATIVO']) == 1) {
                        ...
                        <div id="msglogin" style="display: none;width: 500px;height: 100px;line-height: 100px;position: absolute;top: 50%;left: 50%;margin-top: -50px;margin-left: -250px;z-index: 15;background: white;border-radius: 3px;box-shadow: 0 0px 10px rgba(0, 0, 0, 0.2)">
                            <p style="margin:0;padding: 0;font-size: 18px;color: #333;">Produto movido para o estoque!</p>
                        </div>
                ...
                if (isset($_SESSION['MENSAGEMALTERAR'])) {
                    if (($_SESSION['MENSAGEMALTERAR']) == 1) {
                        ...
                        <div id="msglogin" style="display: none;width: 500px;height: 100px;line-height: 100px;position: absolute;top: 50%;left: 50%;margin-top: -50px;margin-left: -250px;z-index: 15;background: white;border-radius: 3px;box-shadow: 0 0px 10px rgba(0, 0, 0, 0.2)">
                            <p style="margin:0;padding: 0;font-size: 18px;color: #333;">Produto alterado com sucesso!</p>
                        </div>
                ...
                if (isset($_SESSION['MENSAGEMCADASTRO'])) {
                    if (($_SESSION['MENSAGEMCADASTRO']) == 1) {
                        ...
                        <div id="msglogin" style="display: none;width: 500px;height: 100px;line-height: 100px;position: absolute;top: 50%;left: 50%;margin-top: -50px;margin-left: -250px;z-index: 15;background: white;border-radius: 3px;box-shadow: 0 0px 10px rgba(0, 0, 0, 0.2)">
                            <p style="margin:0;padding: 0;font-size: 18px;color: #333;">Produto cadastrado com sucesso!</p>
                        </div>
...
//            header('Location:Visao/listarCliente.php');
            ...
            case 'remover':
                ...
                if ($deletar) {
                    ...
                    echo "<script>
                        window.location.href='Restrito.php?PAGINA=lixeira'; 
                        </script>";
...
//                        </script>";
            ...
            case 'excluir':
                ...
                $produtoDAO = new ClasseProdutoDAO();
                $deletar = $produtoDAO->excluirProduto($codProduto);
            ...
            case 'alterar':
                ...
                if (!empty($alterarfoto["name"])) {
                    ...
                    if (isset($_POST['atualizarquantidade'])) {
                        $atualizarquantidade = $_POST['atualizarquantidade'];
                    } else {
                    ...
                    $novoProduto->setImagem($nome_imagem);
                    $novoProduto->setCategoria($categoria);
                    $novoProduto->setQuantidade($atualizarquantidade);
