...
<html>
    ...
    <body>
        ...
        $query = mysql_query("SELECT * FROM codvenda WHERE codVenda = '$codVenda'");
        ...
        <a href="Restrito.php?PAGINA=Controladorvendas&&codVendas=<?php echo $codVenda; ?>" id="mensagemenviarparaentrega" style="height: 80px;line-height: 80px;font-size: 22px;color: white;width: 700px;position: absolute;top: 50%;left: 50%;margin-top: -40px;border-radius: 3px;margin-left: -350px">
                Enviar para entrega
            </a>
        <?php }
        ?>
